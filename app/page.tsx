    ...
    <div className="space-y-6 pb-5 bg-gray-50 min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gray-900 text-white h-[300px] flex flex-col items-center justify-center">
        ...
        <motion.div 
          ...
          className="relative z-7 max-w-5xl mx-auto text-center px-6 -mt-20"
        >
      ...
      <section className="container mx-auto px-4 pt-16 pb-8">
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            <Link href="/pgs?type=PG&gender=Boys" className="group relative block rounded-2xl overflow-hidden h-80 shadow-md hover:shadow-2xl transition-all duration-300">
              <Image 
          ...
          {/* Girls PG */}
          <motion.div variants={fadeInUp}>
            <Link href="/pgs?type=PG&gender=Girls" className="group relative block rounded-2xl overflow-hidden h-80 shadow-md hover:shadow-2xl transition-all duration-300">
              <Image 
          ...
          {/* Co-Living */}
          <motion.div variants={fadeInUp}>
            <Link href="/pgs?type=PG&gender=Co-Living" className="group relative block rounded-2xl overflow-hidden h-80 shadow-md hover:shadow-2xl transition-all duration-300">
              <Image 
          ...
          >
            {[
              ...
              <motion.div 
                key={idx} 
                variants={fadeInUp}
                className="flex flex-col items-center text-center group p-6 rounded-2xl hover:bg-blue-50 transition-colors duration-300"
              >
      ...
      <section className="py-20 bg-gray-900 text-white relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">Join thousands of happy tenants who found their perfect stay with BR31 Rentals.</p>
